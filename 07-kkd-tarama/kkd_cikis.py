"""
KKD ÇIKIŞ (Ayrılan Personel İade Listesi) - PDF isimlendirme.

Bir klasördeki isimlendirilmemiş PDF'leri (IMG_0001.pdf, IMG_0002.pdf ...)
tek tek açar, üst kısmı (AD SOYAD + GÖREV alanı) küçük bir pencerede
ekranın üst kısmında gösterir. Sen ismi yazarsın, dosya yeniden adlandırılır.

Kullanım:
  1. Bu script'i PDF'lerin olduğu klasöre koy (veya KLASOR değişkenini ayarla).
  2. python kkd_cikis.py
...
DOSYA_FILTRESI = "*.pdf"        # Hangi dosyalar işlensin
ON_IZLEME_ORANI = 0.18          # Sayfanın üstten ne kadarı gösterilsin
